  ...
  return (
    <div id="settings" className="settings">
      ...
      <form className="flex flex-col">
        <div className=" lg:grid-cols-2 grid gap-x-10 gap-y-8">
        ...
        <button
          type="submit"
          className="w-full px-10 py-4 leading-none bg-myBlack rounded-full text-xl text-white mt-8 self-end"
        >
          <span className="relative top-0.5"> Save changes</span>
        </button>
      </form>
      <div className="settings__divider"></div>
